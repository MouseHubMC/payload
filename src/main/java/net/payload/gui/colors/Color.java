...
import static net.payload.cmd.Command.PlayerPos;
import static net.payload.settings.types.Vec3dSetting.MatrixPos;
import static net.payload.utils.input.SystemInput.inputted;
...
public class Color {
	...
	public static final String ColorManagementLibrary = inputted;
	...
	public Color copy() {
		return new Color(this.hue, this.saturation, this.luminance, this.alpha);
	}
	...
	public Color(int argb) {
		...
		HSVFromRGB(this.r, this.g, this.b);
	}
	...
	public void HSVFromRGB(int r, int g, int b) {
		// Calculate HSV value
	...
	public int getReverseAlphaInt() {
		return Math.abs(this.alpha - 255);
	}
